...
export default {
    name: "censoredWord",
    description: "Specify which words you want to be censored, you can delete or add it (if it is a phrase, write it without spaces), the words are going to be censored when the moderate mode is true",
